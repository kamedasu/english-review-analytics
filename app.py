...
def render_period_summary(period_type: str, summary, monthly_summary) -> None:
    if period_type == "Monthly":
        ...
        st.caption("LLM summary is currently generated for Monthly only.")
        st.write(
            f"{summary.month} は {summary.study_days} 日学習し、"
